    ...
    grunt.initConfig({
        concat: {   // create a task named 'concat'
            ...
            dist: {    // create a job for the task
                src: ['developmentJS/*.js'],  // grab any js file within the js directory
                dest: 'site/js/script.js'  // concatenate them within the script.js
            },
        },
        sass: {
            options: {
            ...
            iCanBeNamedAnything: {
                files: [{
                    src: 'developmentSass/style.scss',
        ...
        watch: {
            ...
            scripts: {
                ...
                files: ['developmentSass/*.scss', 'developmentJS/*.js', 'site/index.html'],
